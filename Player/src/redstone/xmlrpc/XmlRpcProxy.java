...
public class XmlRpcProxy implements InvocationHandler
{
    ...
    {
        return createProxy( url, null, interfaces, streamMessages, null);
    }
    ...
    {
    	XmlRpcProxy proxy = new XmlRpcProxy( url, objectName, streamMessages );
    	proxy.setRequestProperties(requestProperties);
        ...
        throws XmlRpcException, XmlRpcFault
    {
        ...
        //Looks like opensubtitle.org doesn't like the handlerName thingy
